...
Wherever it arises in your thinking, and not as a closing ritual, double-check the operative part against what you are actually asking for — re-derive the relief from the provision that grounds it, or read the draft as your opponent would, or verify a date or a section number against your instructions. Say the doubt in the words you would actually use — "let me check", "actually,", "to confirm", "am I sure", "let me reconsider".
