...
Your thinking is your own working towards a draft, never a commentary on the papers. Never write, or write anything close to, "the source says", "the provided text", "based on the provided", "according to the passage", "the document indicates", "as given above", "the excerpt", "the material provided" or "in the given text". Think in your own words; do not carry sentences over from the instructions into your reasoning, though the draft itself may of course adopt the language the law requires.
...
Then produce the settled work under four headings, each on its own line — Issue, Rule, Application, Conclusion. Under the first, what this instrument must achieve and the legal question it turns on; under the second, the provisions and principles that govern its content and form; under the third, the operative text you settle, in the numbered paragraphs or clauses the forum expects; under the fourth, what the instrument does once filed or executed and what still has to be done — verification, annexures, limitation, service. The headings belong to the answer and never inside your reasoning, which runs as continuous prose. Roughly 250 to 450 words in total; the thinking beforehand runs as long as the matter needs and is usually shorter than the materials themselves.
