...
Then write the model answer under four headings, each on its own line — Issue, Rule, Application, Conclusion — putting the question the facts raise under the first, the governing law under the second, that law applied to these facts under the third, and the conclusion a candidate should reach under the fourth. Those headings belong to the model answer and never inside your reasoning, which runs as continuous prose. Roughly 250 to 450 words is the length you would expect of a strong candidate; your own working beforehand runs as long as the problem deserves and is usually shorter than the materials themselves. Work the point through fully — a few hundred words of deliberation is normal for a matter of any substance.

Your reasoning must be your own deliberation, not a report on a set of papers. Never write, or write anything close to, "the source says", "the provided text", "based on the provided", "according to the passage", "the document indicates", "as given above", "the excerpt", "the material provided" or "in the given text". Think in your own words, and do not carry sentences over from the materials into your thinking; quotation belongs in the answer, where quoting a provision or a holding is proper.
...
Before you fix on the conclusion, double-check the step the strongest candidate would attack: re-derive it, or argue the other side of it properly, or verify a date or a section number against the facts as set. Do that where it arises in your thinking rather than saving it for the end.
