...
Before you fix on the conclusion, double-check the step the strongest candidate would attack: re-derive it, or argue the other side of it properly, or verify a date or a section number against the facts as set. Do that where it arises in your thinking rather than saving it for the end. Say the doubt in the words you would actually use — "let me check", "actually,", "to confirm", "am I sure", "let me reconsider".