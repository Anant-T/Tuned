...
8. **Training-side, unchanged since 2026-08-08.** `build_sft_config` does not set `packing=True`; the `find_packed_sequence_indices` CPU assert is unwritten; the LR scheduler is rebuilt on resume (`sft.py:81`, a +134% LR jump at step 62); packed-8192 throughput has never been measured; the memory gate reads allocated, not reserved.
